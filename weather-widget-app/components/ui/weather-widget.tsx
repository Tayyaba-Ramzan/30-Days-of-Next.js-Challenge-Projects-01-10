      ...
      <Card className="w-[90%] max-w-md mx-auto text-center mb-80 bg-transparent border-black rounded-3xl">
        ...
        <CardContent>
          <form onSubmit={handleSearch} className="flex items-center gap-2">
            ...
            />
            <Button type="submit" disabled={isLoading} className="hover:bg-blue-300 hover:text-black font-semibold transition duration-300 bg-black text-white rounded-3xl">
